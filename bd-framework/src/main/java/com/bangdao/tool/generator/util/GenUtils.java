package com.bangdao.tool.generator.util;

import com.bangdao.common.constant.CommonMap;
...
import com.bangdao.framework.config.GenConfig;
import com.bangdao.tool.generator.domain.ColumnInfo;
import com.bangdao.tool.generator.domain.TableInfo;
...
public class GenUtils {
     ...
     * 项目空间路径
     */
    private static final String PROJECT_PATH = "main/java/com/bangdao";
...
/*        templates.add("templates/vm/html/list.html.vm");
        ...
        templates.add("templates/vm/java/groupMessageAdd.java.vm");
        templates.add("templates/vm/java/groupMessageUpdate.java.vm");
        templates.add("templates/vm/java/requestVo.java.vm");
        templates.add("templates/vm/java/responseVo.java.vm");
        return templates;
    }
...
//        String htmlPath = TEMPLATES_PATH + "/" + moduleName + "/" + classname;
        ...
        //添加控制器中请求实体类
        if (template.contains("requestVo.java.vm")) {
            return javaPath + "requestVo" + "/" + classname + "/" + className + "Req.java";
        }

        //添加控制器中响应实体类
        if (template.contains("responseVo.java.vm")) {
            return javaPath + "responseVo" + "/" + classname + "/" + className + "Resp.java";
        }

        if (template.contains("groupMessageAdd.java.vm")) {
            return javaPath + "group" + "/" + classname + "/" + className + "Add.java";
        }

        if (template.contains("groupMessageUpdate.java.vm")) {
            return javaPath + "group" + "/" + classname + "/" + className + "Update.java";
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getModuleName("com.bangdao.project.system"));
    }
}
